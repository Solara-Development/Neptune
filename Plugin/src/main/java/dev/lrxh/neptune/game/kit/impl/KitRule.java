...
public enum KitRule implements IKitRule {
    ...
    ADVANCED_KIT_EDITOR(Material.NETHERITE_SWORD, "Allow players to edit multiple whitelist-restricted loadouts for this kit.", "Advanced Kit Editor", "advancedKitEditor", false),
