...
public class ArenaManagementMenu extends Menu {
    ...
    public List<Button> getButtons(Player player) {
        ...
        if (!arena.isSetup() || !arena.isDoneLoading()) {
            ...
            buttons.add(new DisplayButton(22, Material.MAP, "&aTeleport to arena", List.of("&7Click to teleport to this arena's blue spawn"), o -> player.teleport(arena.getBlueSpawn())));
