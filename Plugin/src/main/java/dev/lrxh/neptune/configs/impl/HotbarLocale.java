...
public enum HotbarLocale implements IDataAccessor {
    ...
    IN_EVENT_EVENT_INFO_NAME("ITEMS.IN_EVENT.EVENT_INFO.NAME", DataType.STRING, "&fEvent Info &7(Right Click)"),
    IN_EVENT_EVENT_INFO_MATERIAL("ITEMS.IN_EVENT.EVENT_INFO.MATERIAL", DataType.STRING, "NETHER_STAR"),
    IN_EVENT_EVENT_INFO_LORE("ITEMS.IN_EVENT.EVENT_INFO.LORE", DataType.STRING_LIST, " "),
    IN_EVENT_EVENT_INFO_SLOT("ITEMS.IN_EVENT.EVENT_INFO.SLOT", DataType.INT, "0"),
    IN_EVENT_EVENT_INFO_ENABLED("ITEMS.IN_EVENT.EVENT_INFO.ENABLED", DataType.BOOLEAN, "true"),
    IN_EVENT_EVENT_LEAVE_NAME("ITEMS.IN_EVENT.EVENT_LEAVE.NAME", DataType.STRING, "&cLeave Event &7(Right Click)"),
    IN_EVENT_EVENT_LEAVE_MATERIAL("ITEMS.IN_EVENT.EVENT_LEAVE.MATERIAL", DataType.STRING, "RED_DYE"),
    IN_EVENT_EVENT_LEAVE_LORE("ITEMS.IN_EVENT.EVENT_LEAVE.LORE", DataType.STRING_LIST, " "),
    IN_EVENT_EVENT_LEAVE_SLOT("ITEMS.IN_EVENT.EVENT_LEAVE.SLOT", DataType.INT, "8"),
    IN_EVENT_EVENT_LEAVE_ENABLED("ITEMS.IN_EVENT.EVENT_LEAVE.ENABLED", DataType.BOOLEAN, "true"),
    IN_EVENT_STATS_NAME("ITEMS.IN_EVENT.STATS.NAME", DataType.STRING, "&eYour Stats &7(Right Click)"),
    IN_EVENT_STATS_MATERIAL("ITEMS.IN_EVENT.STATS.MATERIAL", DataType.STRING, "PLAYER_HEAD"),
    IN_EVENT_STATS_LORE("ITEMS.IN_EVENT.STATS.LORE", DataType.STRING_LIST, " "),
    IN_EVENT_STATS_SLOT("ITEMS.IN_EVENT.STATS.SLOT", DataType.INT, "4"),
    IN_EVENT_STATS_ENABLED("ITEMS.IN_EVENT.STATS.ENABLED", DataType.BOOLEAN, "true"),
    LOBBY_EVENT_START_NAME("ITEMS.IN_LOBBY.EVENT_START.NAME", DataType.STRING, "&bStart Event &7(Right Click)"),
    LOBBY_EVENT_START_MATERIAL("ITEMS.IN_LOBBY.EVENT_START.MATERIAL", DataType.STRING, "FIRE_CHARGE"),
    LOBBY_EVENT_START_LORE("ITEMS.IN_LOBBY.EVENT_START.LORE", DataType.STRING_LIST, " "),
    LOBBY_EVENT_START_SLOT("ITEMS.IN_LOBBY.EVENT_START.SLOT", DataType.INT, "5"),
    LOBBY_EVENT_START_ENABLED("ITEMS.IN_LOBBY.EVENT_START.ENABLED", DataType.BOOLEAN, "true");
