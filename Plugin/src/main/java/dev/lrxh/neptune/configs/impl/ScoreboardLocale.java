...
public enum ScoreboardLocale implements IDataAccessor {
    ...
    PARTY_LOBBY("SCOREBOARDS.PARTY.LOBBY", DataType.STRING_LIST,
            ...
            "&bserver.net",
            "&7&m--------------------"),
    IN_EVENT_LMS("SCOREBOARDS.IN_EVENT.LMS", DataType.STRING_LIST,
            "&7&m--------------------",
            "&bLast Man Standing",
            " ",
            "&fAlive: &b<event-alive>",
            "&fKit: &b<kit>",
            " ",
            "&bserver.net",
            "&7&m--------------------"),
    IN_EVENT_TOURNAMENT("SCOREBOARDS.IN_EVENT.TOURNAMENT", DataType.STRING_LIST,
            "&7&m--------------------",
            "&bTournament",
            " ",
            "&fOpponent: &b<opponent>",
            "&fKit: &b<kit>",
            "&fRound: &b<event-round>",
            " ",
            "&bserver.net",
            "&7&m--------------------"),
    IN_EVENT_SUMO("SCOREBOARDS.IN_EVENT.SUMO", DataType.STRING_LIST,
            "&7&m--------------------",
            "&bSumo",
            " ",
            "&fOpponent: &b<opponent>",
            ...
            "&bserver.net",
            "&7&m--------------------"),
    IN_EVENT_WAITING("SCOREBOARDS.IN_EVENT.WAITING", DataType.STRING_LIST,
            "&7&m--------------------",
            "&bEvent Lobby",
            " ",
            "&fType: &b<event-type>",
            "&fKit: &b<kit>",
            "&fPlayers: &b<event-players>",
            " ",
            "&bserver.net",
            "&7&m--------------------");
