...
public enum MessagesLocale implements IDataAccessor {
    ...
    KIT_EDITOR_RESET("KIT_EDITOR.RESET", "This is sent when the player resets a kit.", DataType.STRING_LIST,
            "&aKit has been reset."),
    RANKED_LOADOUT_CREATED("RANKED_LOADOUT.CREATED", DataType.STRING_LIST, "&aCreated loadout &b<loadout>&a."),
    RANKED_LOADOUT_DELETED("RANKED_LOADOUT.DELETED", DataType.STRING_LIST, "&cDeleted loadout &b<loadout>&c."),
    RANKED_LOADOUT_SELECTED("RANKED_LOADOUT.SELECTED", DataType.STRING_LIST, "&aSelected loadout &b<loadout>&a."),
    RANKED_LOADOUT_MAX("RANKED_LOADOUT.MAX", DataType.STRING_LIST, "&cYou have reached your loadout limit (&f<max>&c)."),
    RANKED_LOADOUT_CREATE_FAIL("RANKED_LOADOUT.CREATE-FAIL", DataType.STRING_LIST, "&cCould not create loadout."),
    RANKED_LOADOUT_RESET("RANKED_LOADOUT.RESET", DataType.STRING_LIST, "&aReset active loadout for &b<kit>&a."),
    RANKED_LOADOUT_CANT_STACK("RANKED_LOADOUT.CANT-STACK", DataType.STRING_LIST, "&cThis item cannot be stacked."),
    RANKED_LOADOUT_CANT_ENCHANT("RANKED_LOADOUT.CANT-ENCHANT", DataType.STRING_LIST, "&cThis item cannot be enchanted."),
