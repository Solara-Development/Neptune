...
public enum MenusLocale implements IDataAccessor {
    ...
    KIT_EDITOR_CUSTOM_KITS_SLOT("KIT_EDITOR.CUSTOM_KITS.SLOT", DataType.INT, "35"),
    KIT_EDITOR_CUSTOM_KITS_MATERIAL("KIT_EDITOR.CUSTOM_KITS.MATERIAL", DataType.STRING, "NETHER_STAR"),
    KIT_EDITOR_CUSTOM_KITS_NAME("KIT_EDITOR.CUSTOM_KITS.NAME", DataType.STRING, "&bCustom Kits"),
    KIT_EDITOR_CUSTOM_KITS_LORE("KIT_EDITOR.CUSTOM_KITS.LORE", DataType.STRING_LIST,
            "",
            "&7Manage your custom kits",
            "",
            "&a&lClick to open!"),
    ...
    KIT_RULE_ALLOW_ANY_ARENA_BREAK_ENABLED_NAME("KIT_RULES.ALLOW_ANY_ARENA_BREAK.ENABLED-NAME", DataType.STRING, "&aArena Break (All)"),
    KIT_RULE_ALLOW_ANY_ARENA_BREAK_DISABLED_NAME("KIT_RULES.ALLOW_ANY_ARENA_BREAK.DISABLED-NAME", DataType.STRING, "&cArena Break (All)"),
    KIT_RULE_ALLOW_ANY_ARENA_BREAK_LORE("KIT_RULES.ALLOW_ANY_ARENA_BREAK.LORE", DataType.STRING_LIST, "&7Allow breaking any arena block", "&7without whitelisting block types", "", "&7Click to toggle"),
    KIT_RULE_ALLOW_ANY_ARENA_BREAK_MATERIAL("KIT_RULES.ALLOW_ANY_ARENA_BREAK.MATERIAL", DataType.STRING, "IRON_AXE"),
    ...
    KIT_RULE_ADVANCED_KIT_EDITOR_ENABLED_NAME("KIT_RULES.ADVANCED_KIT_EDITOR.ENABLED-NAME", DataType.STRING, "&aAdvanced Kit Editor"),
    KIT_RULE_ADVANCED_KIT_EDITOR_DISABLED_NAME("KIT_RULES.ADVANCED_KIT_EDITOR.DISABLED-NAME", DataType.STRING, "&cAdvanced Kit Editor"),
    KIT_RULE_ADVANCED_KIT_EDITOR_LORE("KIT_RULES.ADVANCED_KIT_EDITOR.LORE", DataType.STRING_LIST, "&7Allow players to edit multiple", "&7whitelist-restricted loadouts for this kit.", "", "&7Click to toggle"),
    KIT_RULE_ADVANCED_KIT_EDITOR_MATERIAL("KIT_RULES.ADVANCED_KIT_EDITOR.MATERIAL", DataType.STRING, "NETHERITE_SWORD"),
    ...
    ARENA_WHITELIST_TITLE("ARENA.WHITELIST.TITLE", DataType.STRING, "&eWhitelisted Blocks"),
    ARENA_WHITELIST_ADD_MATERIAL("ARENA.WHITELIST.ADD.MATERIAL", DataType.STRING, "GREEN_STAINED_GLASS_PANE"),
    ARENA_WHITELIST_ADD_NAME("ARENA.WHITELIST.ADD.NAME", DataType.STRING, "&aAdd Block"),
    ARENA_WHITELIST_ADD_LORE("ARENA.WHITELIST.ADD.LORE", DataType.STRING_LIST, "&aPress to add"),
    ARENA_WHITELIST_ADD_ALL_MATERIAL("ARENA.WHITELIST.ADD-ALL.MATERIAL", DataType.STRING, "LIME_STAINED_GLASS_PANE"),
    ARENA_WHITELIST_ADD_ALL_NAME("ARENA.WHITELIST.ADD-ALL.NAME", DataType.STRING, "&aAdd All Blocks"),
    ARENA_WHITELIST_ADD_ALL_LORE("ARENA.WHITELIST.ADD-ALL.LORE", DataType.STRING_LIST,
            "&7Adds every breakable block type",
            "&7Protected blocks are skipped:",
            "&8bedrock, barrier, command blocks,",
            "&8structure blocks, portals, spawners"),
    ARENA_WHITELIST_REMOVE_MATERIAL("ARENA.WHITELIST.REMOVE.MATERIAL", DataType.STRING, "RED_STAINED_GLASS_PANE"),
    ARENA_WHITELIST_REMOVE_NAME("ARENA.WHITELIST.REMOVE.NAME", DataType.STRING, "&cRemove Block"),
    ARENA_WHITELIST_REMOVE_LORE("ARENA.WHITELIST.REMOVE.LORE", DataType.STRING_LIST, "&cPress to remove a whitelisted block"),
    ARENA_WHITELIST_ITEM_NAME("ARENA.WHITELIST.ITEM-NAME", DataType.STRING, "&f<block>"),
    ARENA_WHITELIST_ITEM_REMOVE_LORE("ARENA.WHITELIST.ITEM-REMOVE-LORE", DataType.STRING_LIST, "&cLeft click to remove"),
    ARENA_WHITELIST_EMPTY("ARENA.WHITELIST.EMPTY", DataType.STRING, "This arena has no whitelisted blocks to remove."),
    ...
    RANKED_LOADOUT_LIST_TITLE("RANKED_LOADOUT.LIST.TITLE", DataType.STRING, "&b<kit> Loadouts"),
    RANKED_LOADOUT_LIST_SIZE("RANKED_LOADOUT.LIST.SIZE", DataType.INT, "54"),
    RANKED_LOADOUT_LIST_FILTER("RANKED_LOADOUT.LIST.FILTER", DataType.STRING, "FILL"),
    RANKED_LOADOUT_ITEM_NAME("RANKED_LOADOUT.LIST.ITEM-NAME", DataType.STRING, "&f<loadout>"),
    RANKED_LOADOUT_ITEM_ACTIVE_LORE("RANKED_LOADOUT.LIST.ACTIVE-LORE", DataType.STRING_LIST, "&aActive loadout", "", "&7Left-click: &fEdit", "&7Right-click: &fPreview", "&7Shift-right-click: &fDelete"),
    RANKED_LOADOUT_ITEM_INACTIVE_LORE("RANKED_LOADOUT.LIST.INACTIVE-LORE", DataType.STRING_LIST, "&7Inactive loadout", "", "&7Left-click: &fEdit", "&7Right-click: &fSet active", "&7Shift-right-click: &fDelete"),
    RANKED_LOADOUT_CREATE_SLOT("RANKED_LOADOUT.LIST.CREATE.SLOT", DataType.INT, "49"),
    RANKED_LOADOUT_CREATE_MATERIAL("RANKED_LOADOUT.LIST.CREATE.MATERIAL", DataType.STRING, "EMERALD"),
    RANKED_LOADOUT_CREATE_NAME("RANKED_LOADOUT.LIST.CREATE.NAME", DataType.STRING, "&aCreate Loadout"),
    RANKED_LOADOUT_CREATE_LORE("RANKED_LOADOUT.LIST.CREATE.LORE", DataType.STRING_LIST, "&7Loadouts: &f<loadouts>&7/&f<max>"),
    RANKED_LOADOUT_EDITOR_TITLE("RANKED_LOADOUT.EDITOR.TITLE", DataType.STRING, "&bEdit Loadout"),
    RANKED_LOADOUT_EDITOR_SIZE("RANKED_LOADOUT.EDITOR.SIZE", DataType.INT, "54"),
    RANKED_LOADOUT_PREVIEW_TITLE("RANKED_LOADOUT.PREVIEW.TITLE", DataType.STRING, "&bLoadout Preview"),
    RANKED_LOADOUT_PREVIEW_SLOT("RANKED_LOADOUT.PREVIEW.SLOT", DataType.INT, "52"),
    RANKED_LOADOUT_PREVIEW_MATERIAL("RANKED_LOADOUT.PREVIEW.MATERIAL", DataType.STRING, "ENDER_EYE"),
    RANKED_LOADOUT_PREVIEW_NAME("RANKED_LOADOUT.PREVIEW.NAME", DataType.STRING, "&ePreview Loadout"),
